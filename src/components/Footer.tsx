        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-5 max-w-sm text-sm leading-relaxed text-taupe">
              مجالس عربية وخليجية، غرف ضيوف وصالونات، غرف نوم وسفرة، برادي بأنواعها،
              وأفخم أقمشة المخمل الأجنبي — بإدارة {SITE.manager}.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-taupe">
              ...
              {SITE.phones.slice(0, 2).map((p) => (
                <li key={p.tel} className="flex items-center gap-3">
                  ...
                  <a href={`tel:${p.tel}`} dir="ltr" className="transition-colors hover:text-honey">{p.display}</a>
                </li>
              ))}
            ...
            <a href={waLink()} target="_blank" rel="noopener noreferrer" className="btn-ghost mt-5 text-xs">واتساب</a>
          </div>
        </div>
