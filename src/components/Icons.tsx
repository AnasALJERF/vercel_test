...
const paths: Record<string, string> = {
  fabric: "M3 6c3-2 6 2 9 0s6-2 9 0 M3 12c3-2 6 2 9 0s6-2 9 0 M3 18c3-2 6 2 9 0s6-2 9 0",
  wood: "M12 3v18 M8 5c1.6 2 1.6 12 0 14 M16 5c-1.6 2-1.6 12 0 14 M4.5 7c1.2 2.2 1.2 7.8 0 10 M19.5 7c-1.2 2.2-1.2 7.8 0 10",
  shield: "M12 3l7 3v6c0 4.2-2.9 7.6-7 9-4.1-1.4-7-4.8-7-9V6z M9 12l2 2 4-4",
  hand: "M9 13V5.5a1.5 1.5 0 013 0V12 M12 11V4.5a1.5 1.5 0 013 0V12 M15 11.5V7a1.5 1.5 0 013 0v7.5a6.5 6.5 0 01-6.5 6.5h-1A6.5 6.5 0 016 14.5V12a1.5 1.5 0 013 0",
  scissors: "M6.5 8a2.5 2.5 0 100-5 2.5 2.5 0 000 5z M6.5 21a2.5 2.5 0 100-5 2.5 2.5 0 000 5z M20 4L8.5 16.5 M20 20L8.5 7.5",
  sparkle: "M12 3l1.9 5.6L19.5 10l-5.6 1.9L12 17.5l-1.9-5.6L4.5 10l5.6-1.4z M18.5 16l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8z",
  ruler: "M4 14.5L14.5 4 20 9.5 9.5 20z M8 10l1.5 1.5 M10.5 7.5L12 9 M13 5l1.5 1.5 M6 13l1.5 1.5",
